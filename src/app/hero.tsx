        ...
        <div className="container mx-auto grid min-h-[600px] max-w-7xl grid-cols-1 items-center gap-12 px-4 py-12 lg:grid-cols-2 lg:px-8">
          <div className="flex flex-col justify-center">
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="font-semibold uppercase tracking-wider text-blue-600">RG Property Advisors</span>
            </div>
        ...
        <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-black">
          ...
          <div className="relative z-10 text-center text-white">
            ...
            <h1 className="font-serif text-5xl font-bold sm:text-7xl">
              Experience RG Property Advisors
            </h1>
          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row">
            <div className="lg:w-1/2">
               ...
               <p className="mt-6 text-lg text-slate-600">
                 RG Property Advisors provides expert real estate advisory and investment services across Greater Cleveland. We build wealth through strategic property acquisition.
               </p>
