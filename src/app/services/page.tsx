...
export const metadata: Metadata = {
  ...
  description: "Explore RG Property Advisors' real estate services - residential, multi-family, distressed assets, vacant land, and investment advisory in Lakewood, Bay Village, Westlake, and Greater Cleveland.",
  keywords: [
  ...
  openGraph: {
    title: "Services | Building Restoration & Interior Design in Cleveland",
    description: "Explore RG Property Advisors' real estate services across Greater Cleveland.",
    url: "https://rgpropertyadvisors.com/services",
  },
  alternates: {
    canonical: "https://rgpropertyadvisors.com/services",
  },
}
