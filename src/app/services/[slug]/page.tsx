...
export async function generateMetadata({
  ...
  return {
    title: service.seo_title || `${service.services_title} | RG Property Advisors`,
    description: service.seo_description || service.services_description,
    keywords: service.seo_keywords || [],
    openGraph: {
      title: service.seo_title || `${service.services_title} | RG Property Advisors`,
      description: service.seo_description || service.services_description,
      url: `https://rgpropertyadvisors.com/services/${service.slug}`,
    },
    alternates: {
      canonical: `https://rgpropertyadvisors.com/services/${service.slug}`,
    },
  }
}
...
export default async function ServiceDetailPage({
  ...
  return (
    <div className="flex flex-col">
      ...
      <BreadcrumbJsonLd
        items={[
          { name: "Home", url: "https://rgpropertyadvisors.com" },
          { name: "Services", url: "https://rgpropertyadvisors.com/services" },
          {
