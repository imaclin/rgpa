...
const contactInfo = [
  {
    icon: MapPin,
    label: "Address",
    value: "2001 Crocker Rd #200\nWestlake, OH 44145",
    href: "https://maps.google.com/?q=2001+Crocker+Rd+200+Westlake+OH+44145",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "(216) 408-3082",
    href: "tel:216-408-3082",
  },
  {
    icon: Mail,
    label: "Email",
    value: "info@rgpropertyadvisors.com",
    href: "mailto:info@rgpropertyadvisors.com",
  },
  {
    icon: Instagram,
    label: "Instagram",
    value: "@rg_property_advisors",
            ...
            <div className="flex flex-col justify-center space-y-8">
              <div>
                ...
                <p className="mt-4 text-muted-foreground">
                  Whether you&apos;re ready to buy, sell, or invest, we&apos;re here to help.
