...
export default function SettingsPage() {
  ...
  const [siteSettings, setSiteSettings] = useState({
    ...
    siteDescription: "Greater Cleveland's top 1% real estate advisors",
    contactEmail: "info@rgpropertyadvisors.com",
    contactPhone: "(216) 408-3082",
    address: "2001 Crocker Rd #200\nWestlake, OH 44145",
    instagram: "https://www.instagram.com/rg_property_advisors/",
  })
